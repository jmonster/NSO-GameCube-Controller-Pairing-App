...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ui.cal_sticks": {
        "en": "Calibrate Sticks",
        "fr": "Calibrer les sticks",
        "ja": "スティックのキャリブレーション",
        "es": "Calibrar sticks",
        "de": "Sticks kalibrieren",
        "pt": "Calibrar analógicos",
        "it": "Calibra stick",
    },
    "ui.connected_ble": {
    ...
    "settings.rumble_intensity": {
        "en": "Rumble Intensity",
        "fr": "Intensité de la vibration",
        "ja": "振動の強さ",
        "es": "Intensidad de vibración",
        "de": "Rumble-Intensität",
        "pt": "Intensidade da vibração",
        "it": "Intensità vibrazione",
    },
    "settings.map_home_to_guide": {
        "en": "Map Home button to Xbox Guide",
        "fr": "Mapper Home vers le bouton Guide Xbox",
        "ja": "HomeボタンをXboxガイドに割り当てる",
        "es": "Asignar Home al botón Guide de Xbox",
        "de": "Home-Taste der Xbox-Guide-Taste zuordnen",
        "pt": "Mapear Home para o botão Guide do Xbox",
        "it": "Mappa Home sul pulsante Guide Xbox",
    },
